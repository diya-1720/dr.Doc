      ...
      <main className="flex-1 p-6 md:p-8 max-w-7xl">
        ...
        {currentDoc && (
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            {/* Left Column: Interactive Document Preview with Bounding Box Annotations */}
            <div className="lg:col-span-6 bg-[#FFF8EA] border-2 border-[#3F2928] p-4 shadow-[4px_4px_0px_#3F2928] relative">
              ...
              <div className="relative border border-[#3F2928] bg-[#3F2928]/5 overflow-hidden min-h-[400px] flex items-center justify-center">
                <img
            ...
            <div className="lg:col-span-6 bg-[#FFF8EA] border-2 border-[#3F2928] p-6 shadow-[4px_4px_0px_#3F2928]">
              
              <div className="flex justify-between items-center mb-6 pb-2 border-b border-[#3F2928]">
                <div>
                ...
                <button
                  ...
                  className="font-mono text-xs font-bold bg-[#3F2928] text-[#FFF8EA] px-3 py-1.5 border border-[#3F2928] shadow-[2px_2px_0px_#7A302F] flex items-center gap-1.5 hover:bg-[#7A302F] transition-colors"
                >
                ...
                {currentDoc.extractedFields.map((field) => (
                  ...
                  >
                    <div>
                      ...
                      <div className="font-bold text-sm text-[#3F2928] mt-0.5 select-all">
                        {field.value}
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-3 self-end sm:self-center">
                      ...
                      <button
                        ...
                        className="p-1 hover:bg-[#E8B9B8] border border-[#3F2928] text-[#3F2928] transition-colors"
              ...
              {/* Raw Text Output Accordion / Block */}
              <div className="mt-8 pt-4 border-t border-[#3F2928]">
                <div className="font-mono text-xs font-bold text-[#3F2928] mb-2">
                  RAW UNSTRUCTURED OCR STREAM
                </div>
                <pre className="bg-[#3F2928] text-[#FFF8EA] p-4 font-mono text-[11px] leading-relaxed border border-[#3F2928] max-h-48 overflow-y-auto whitespace-pre-wrap">
