          ...
          {[
            ...
            return (
              <button
                ...
                className={`px-4 py-2 border font-bold flex items-center gap-2 transition-all ${
                  isActive
        ...
        <div className="bg-[#FFF8EA] border-2 border-[#3F2928] p-8 shadow-[6px_6px_0px_#3F2928]">
          ...
          <div className="mb-6">
            ...
            <button
              ...
              className="bg-[#F3E4C8] hover:bg-[#FFF8EA] text-[#3F2928] px-6 py-4 border-2 border-dashed border-[#3F2928] font-mono text-xs font-bold w-full text-center flex items-center justify-center gap-2"
            >
              <Upload className="w-5 h-5 text-[#7A302F]" />
              {selectedFile 
          ...
          {activeTool === 'compress' && (
            <div className="space-y-6 font-mono text-xs">
              ...
              <button
                ...
                className="bg-[#7A302F] hover:bg-[#5c2322] text-[#FFF8EA] px-6 py-3 border-2 border-[#3F2928] shadow-[3px_3px_0px_#3F2928] font-heading text-lg font-bold disabled:opacity-50"
              >
              ...
              {compressedResult && (
                <div className="p-4 bg-[#F3E4C8] border-2 border-[#7A302F] mt-6">
                  <div className="font-heading text-xl font-bold text-[#7A302F] mb-2 flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="bg-[#7A302F] text-[#FFF8EA] px-5 py-2 border border-[#3F2928] shadow-[2px_2px_0px_#3F2928] font-bold flex items-center gap-2"
                  >
          ...
          {activeTool === 'convert' && (
            <div className="space-y-6 font-mono text-xs">
              ...
              <button
                ...
                className="bg-[#7A302F] text-[#FFF8EA] px-6 py-3 border-2 border-[#3F2928] shadow-[3px_3px_0px_#3F2928] font-heading text-lg font-bold disabled:opacity-50"
              >
